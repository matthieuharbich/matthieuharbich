...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "wines_locales" (
  	"description" varchar,
  	"notes" jsonb,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "wines_locales_locale_parent_id_unique" ON "wines_locales" USING btree ("_locale","_parent_id");
